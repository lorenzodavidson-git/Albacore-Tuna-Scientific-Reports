...
The main Matlab scripts to process the data and create the figures are named FISH_Process_Final.m and FISH_Figures_Final_Revised.m, respectively. These scripts utilize functions that can be found in the folders named "util" and "code". 
Running the FISH_Process_Final.m creates new files that are used by the FISH_Figures_Final_Revised.m to visualize the data. 
