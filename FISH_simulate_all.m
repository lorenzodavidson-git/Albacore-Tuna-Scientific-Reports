function [x, y, tf, u, v, month, mld_fish] = FISH_simulate_all(lon, lat, u, v, dt, time, sst, fish,type)
...
%   sst  - Structure containing sea surface temperature data and related
%   fields (including MLD)
%   
...
for t = 1:length(dt)
    ...
    if type == "null"
        flag = 0; % use temperature constraint
